...
//        mySql.close()    
    ...
    private func getTV() -> Any? {
        ...
        mySql.storeResults()?.forEachRow(callback: { (row) in
            ...
            dict.updateValue(row[2] as Any, forKey: "baidu_link")
            dict.updateValue(row[3] as Any, forKey: "baidu_pwd")
            dict.updateValue(row[4] as Any, forKey: "bili_av")
            dict.updateValue(row[5] as Any, forKey: "bili_link")
            dict.updateValue(row[7] as Any, forKey: "mark")
            dict.updateValue(row[8] as Any, forKey: "create_time")
            dict.updateValue(row[9] as Any, forKey: "update_time")
    ...
    private func getCUT() -> Any? {
        ...
        mySql.storeResults()?.forEachRow(callback: { (row) in
            ...
            dict.updateValue(row[4] as Any, forKey: "bili_av")
            dict.updateValue(row[5] as Any, forKey: "bili_link")
            dict.updateValue(row[6] as Any, forKey: "bili_full")
            dict.updateValue(row[7] as Any, forKey: "bili_full_link")
            dict.updateValue(row[8] as Any, forKey: "mark")
            dict.updateValue(row[10] as Any, forKey: "create_time")
            dict.updateValue(row[11] as Any, forKey: "update_time")
